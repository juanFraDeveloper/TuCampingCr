...
$(document).ready(function(){
	...
	if(ancho < 650){$("#img-change").attr('src', 'img/reserva(movil).jpg');}
...
function funMostrarMovliHeader(){
	$(document).ready(function(){
		//header
		$('.headerScroll1').css('transform', 'translateX(0)');
		$('.headerScroll1').css('opacity', '1');
		$('.headerScroll2').css('transform', 'translateX(0)');
		$('.headerScroll2').css('opacity', '1');
		$('.headerScroll3').css('transform', 'scale(1)');
		$('.headerScroll4').css('transform', 'translateX(0)');
		$('.headerScroll5').css('transform', 'scale(1)');
	})
}
/*====================================
DOM
...
window.matchMedia('(orientation: portrait)').addListener(function(m) {
	$(document).ready(function(){
		if(ancho < 650){
			if(m.matches){
				$("#img-change").attr('src', 'img/reserva(movil).jpg');
			}else{
				$("#img-change").attr('src', 'img/reserva.jpg');
			}
		}
		if(ancho < 500){
			if(m.matches){
